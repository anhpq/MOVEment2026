...
## Corpus Check
- 245 files · ~430,301 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2843 nodes · 4758 edges · 234 communities (193 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `315fbee0`
...
10. `TeamGameplayV2Page()` - 29 edges
...
## Communities (234 total, 41 thin omitted)
...
Cohesion: 0.06
Nodes (43): loginTeam(), loginTeamWithQr(), loginUser(), LANGUAGE_FLAGS, LanguageSwitch(), LanguageSwitchProps, cameraErrorKeys, CameraFailureCategory (+35 more)
...
### Community 18 - "api.ts"
Cohesion: 0.07
Nodes (57): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationQrTokenResponse, AdminStationUpdateInput, AdminTeamResponse, cancelPlayerStation() (+49 more)
...
Cohesion: 0.06
Nodes (31): 2026-08-02 Shared UI usability baseline, 2026-08-03 Check-in QR modal presentation, Actors, Admin, Audit and Logging, Authentication and Session, Authority, Check-in (+23 more)
...
Cohesion: 0.22
Nodes (11): createUniqueStationQrToken(), deleteStationRelatedActivityLogs(), replaceAllStations(), StationReplacementResult, verifyCanonicalStationState(), CANONICAL_QR_PURPOSES, CANONICAL_STATION_IDS, CANONICAL_STATION_INPUT (+3 more)
...
Cohesion: 0.06
Nodes (67): checkInStation(), buildFallbackPositions(), buildMarkerPosition(), clampMapScale(), clampPercent(), getMarkerLegendBackground(), getMarkerUiState(), isValidMapCoordinate() (+59 more)
...
Cohesion: 0.13
Nodes (34): qrcode, displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, createAdminStation(), createAdminTeam(), getAdminProgressMatrix() (+26 more)
...
Cohesion: 0.14
Nodes (12): ActivityLogService, Injectable, PLAYER_ERROR_CODES, PlayerActionException, PlayerErrorCode, mockActivityLog, mockEventConfig, mockPrisma (+4 more)
...
Cohesion: 0.08
Nodes (4): isSupportedYoutubeUrl(), AdminService, Injectable, XlsxCell
...
Cohesion: 0.05
Nodes (43): 2026-07-29 Runtime Stability Integration, 2026-07-30 Decision Log, 2026-07-30 Marker anchor and footer reference refinement, 2026-07-30 Review Decision Log, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-30 V2-owned Detail and map HUD refinement, 2026-07-31 Background-only overlay opacity (+35 more)
...
Cohesion: 0.08
Nodes (40): getPlayerCatalog(), getPlayerDashboard(), getPlayerProgress(), getPlayerState(), getPlayerStationImages(), getPlayerStations(), getSafeApiErrorTranslationKey(), isCompatibilityFallback() (+32 more)
...
Cohesion: 0.21
Nodes (15): @prisma/client, validateCanonicalStations(), assertMutationAllowed(), assertSchemaReady(), auditOnly, AuditSnapshot, collectAudit(), getGameTypeConstraintValues() (+7 more)
...
Cohesion: 0.16
Nodes (17): App(), authMatchesSession(), AuthMeResponse, getMe(), ProtectedRoute(), ProtectedRouteProps, MovementRoutes(), getSessionPrincipalKey() (+9 more)
...
Cohesion: 0.22
Nodes (7): FullscreenToggleResult, isFullscreenSupported(), isStandaloneDisplayMode(), StandaloneNavigator, TEAM_V2_FULLSCREEN_CHANGE_EVENTS, WebkitFullscreenDocument, WebkitFullscreenElement
...
Cohesion: 0.15
Nodes (12): 2026-07-29 Runtime Stability Integration, 2026-08-03 Station List camera-first Check-in, Business Rule References, Current Implementation, Decision Log, Decisions and Stale Assumptions, Interfaces and Data, Objective and Scope (+4 more)
...
Cohesion: 0.06
Nodes (35): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+27 more)
...
Cohesion: 0.08
Nodes (24): AdminOperationsPage, FinalPage, LeaderboardPage, LoginPage, ProtectedRoute, QrLoginPage, RoleAwareFallback(), StationDetailPage (+16 more)
...
Cohesion: 0.08
Nodes (25): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+17 more)
...
Cohesion: 0.11
Nodes (17): Acceptance Criteria, Completed before pause, Confirmed Findings, Documentation Routing, Execution Checkpoint — 2026-07-29 17:12 Asia/Saigon, Follow-up hot-path audit - 2026-08-02, Implementation Decisions, Network Transfer Optimization - 2026-08-01 (+9 more)
...
Cohesion: 0.10
Nodes (30): FinalResponse, getLeaderboard(), getPlayerFinal(), getPlayerLeaderboard(), getPlayerStationPlayingCounts(), runPlayerRead(), StationPlayingCountResponse, submitFinalAnswer() (+22 more)
...
Cohesion: 0.27
Nodes (5): LeaderboardEntryResponse, getTeamV2OverlayStyle(), TeamV2OverlayStyle, LeaderboardOverlay(), getTeamV2LeaderboardRows()
...
Cohesion: 0.19
Nodes (12): createUniqueQrLoginToken(), buildQrLoginUrl(), createQrTokenFingerprint(), createSecureQrLoginToken(), createSecureStationQrToken(), isOfficialQrLoginToken(), isOfficialStationQrToken(), isOfficialStationQrTokenForPurpose() (+4 more)
...
### Community 213 - "admin.service.spec.ts"
Cohesion: 0.33
Nodes (5): mockActivityLog, mockConfig, mockPrisma, mockTeamResults, team

## Knowledge Gaps
- **1431 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1426 more)
...
- **Why does `createQrTokenFingerprint()` connect `createQrTokenFingerprint` to `AuthContext`, `utils.ts`, `reset-gameplay-seed.ts`, `player.service.ts`, `seed.ts`, `auth.service.ts`?**
