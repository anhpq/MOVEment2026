...
## Corpus Check
- 245 files · ~434,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2900 nodes · 4818 edges · 235 communities (194 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0dfb05fd`
...
8. `MOVEment 2026 - Current Specification` - 42 edges
...
Cohesion: 0.12
Nodes (25): AdminScoreDto, ForceProgressStatusDto, ReopenProgressDto, SubmitScoreDto, IsEnum, IsInt, IsNotEmpty, IsOptional (+17 more)
...
Cohesion: 0.10
Nodes (27): LeaderboardEntryResponse, getTeamV2OverlayStyle(), TeamV2OverlayStyle, TeamV2QrBadge(), TeamV2QrBadgeProps, clamp(), clampPercent(), clampScale() (+19 more)
...
### Community 18 - "api.ts"
Cohesion: 0.11
Nodes (31): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, cancelPlayerStation(), checkOutStation() (+23 more)
...
Cohesion: 0.06
Nodes (51): GAME_TYPE_OPTIONS, GAME_TYPES, ROLE_LABELS, STATUS_ORDER, buildFinishedTeamStations(), buildPatchedTeamStations(), buildResetTeamStations(), buildStartedTeamStations() (+43 more)
...
Cohesion: 0.15
Nodes (23): createAdminTeam(), getAdminTeamQrLoginTokens(), updateAdminTeam(), appliedProperties, applyActiveTheme(), ThemeOwner, themeOwners, useBodyTeamTheme() (+15 more)
...
Cohesion: 0.21
Nodes (14): ActivityLogService, Injectable, AdminModule, Module, AuthModule, Module, EventConfigModule, Module (+6 more)
...
Cohesion: 0.25
Nodes (11): AuthContext, CurrentAuth, AdminController, Body, Controller, Param, Patch, Post (+3 more)
...
Cohesion: 0.13
Nodes (26): revokeAdminStationQrToken(), apiDelete(), apiDownloadBlob(), apiDownloadFile(), ApiErrorCode, apiRequest(), buildApiUrl(), createRequestId() (+18 more)
...
Cohesion: 0.06
Nodes (6): isSupportedYoutubeUrl(), getEffectiveStationMaxPoints(), Get, Header, AdminService, Injectable
...
Cohesion: 0.06
Nodes (56): FinalResponse, getPlayerCatalog(), getPlayerDashboard(), getPlayerFinal(), getPlayerProgress(), getPlayerState(), getPlayerStationImages(), getPlayerStations() (+48 more)
...
Cohesion: 0.16
Nodes (22): @prisma/client, createUniqueStationQrToken(), deleteStationRelatedActivityLogs(), replaceAllStations(), StationReplacementResult, verifyCanonicalStationState(), CANONICAL_STATION_IDS, CANONICAL_STATIONS (+14 more)
...
Cohesion: 0.24
Nodes (8): FullscreenToggleResult, getActiveFullscreenElement(), isFullscreenSupported(), isStandaloneDisplayMode(), StandaloneNavigator, toggleBrowserFullscreen(), WebkitFullscreenDocument, WebkitFullscreenElement
...
Cohesion: 0.12
Nodes (29): App(), authMatchesSession(), AuthMeResponse, getLeaderboard(), getMe(), getPlayerLeaderboard(), logout(), useMovementBootstrap() (+21 more)
...
Cohesion: 0.04
Nodes (48): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+40 more)
...
Cohesion: 0.05
Nodes (38): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+30 more)
...
Cohesion: 0.12
Nodes (17): downloadAdminSummary(), downloadAdminTeamResults(), downloadFile(), getAdminActivityLogs(), getAdminDashboard(), getAdminEventConfig(), getAdminFinalConfig(), getAdminFinalSubmissions() (+9 more)

## Knowledge Gaps
- **1489 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1484 more)
