...
## Corpus Check
- 245 files · ~438,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2943 nodes · 4864 edges · 237 communities (194 shown, 43 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7afff87`
...
3. `MOVEment 2026 - Implementation Backlog` - 49 edges
4. `2026-07-28 Station Media Gallery and Player action layout` - 49 edges
5. `MOVEment 2026 - Current Specification` - 49 edges
6. `Team Gameplay V2 Analysis` - 47 edges
...
Cohesion: 0.12
Nodes (29): checkInStation(), getSafeApiErrorTranslationKey(), StationImageGallery(), StationImageGalleryProps, buildFallbackPositions(), buildMarkerPosition(), clampMapScale(), clampPercent() (+21 more)
...
Cohesion: 0.16
Nodes (14): AuthContext, Get, UseGuards, PlayerController, Body, Controller, Get, Header (+6 more)
...
Cohesion: 0.16
Nodes (18): cancelPlayerStation(), checkOutStation(), editAdminProgressScore(), forceAdminProgressStatus(), getPlayerFinal(), reopenAdminProgress(), submitStationScore(), getTeamV2OverlayStyle() (+10 more)
...
Cohesion: 0.07
Nodes (35): LeaderboardEntryResponse, TeamV2QrBadge(), TeamV2QrBadgeProps, TeamV2QrSubmitResult, clamp(), clampPercent(), clampScale(), getBaseMapScale() (+27 more)
...
Cohesion: 0.10
Nodes (32): loginTeam(), loginTeamWithQr(), loginUser(), cameraErrorKeys, CameraFailureCategory, getCameraFailureCategory(), logCameraDiagnostic(), QrTokenInput() (+24 more)
...
### Community 18 - "api.ts"
Cohesion: 0.09
Nodes (41): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, AuthMeResponse, downloadAdminSummary() (+33 more)
...
Cohesion: 0.19
Nodes (11): runPlayerRead(), selectPlayerMapImageVariant(), clearRuntimeRequestCoordinator(), clearSingleFlight(), getNetworkConnection(), getTeamRuntimePollIntervalMs(), inFlightRequests, isReducedDataMode() (+3 more)
...
Cohesion: 0.15
Nodes (11): LeaderboardController, Controller, Get, PLAYER_ERROR_CODES, PlayerActionException, PlayerErrorCode, mockActivityLog, mockEventConfig (+3 more)
...
Cohesion: 0.10
Nodes (31): apiDownloadBlob(), apiDownloadFile(), ApiError, ApiErrorCode, apiPatch(), apiRequest(), buildApiUrl(), createRequestId() (+23 more)
...
Cohesion: 0.08
Nodes (4): getEffectiveStationMaxPoints(), getStationPlaySeconds(), AdminService, Injectable
...
Cohesion: 0.15
Nodes (24): App(), authMatchesSession(), getLeaderboard(), getMe(), getPlayerLeaderboard(), logout(), submitFinalAnswer(), isAuthFailure() (+16 more)
...
Cohesion: 0.03
Nodes (59): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+51 more)
...
Cohesion: 0.04
Nodes (49): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+41 more)
...
Cohesion: 0.08
Nodes (50): qrcode, displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminStation(), createAdminTeam() (+42 more)
...
Cohesion: 0.16
Nodes (17): getStationMarkerAppearance(), isStationMarkerCompleted(), isStationMarkerLocked(), StationMarkerAppearance, StationMarkerStateSource, createMarker(), getLayout(), viewport (+9 more)
...
## Knowledge Gaps
- **1529 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1524 more)
