...
## Corpus Check
- 245 files · ~438,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2952 nodes · 4869 edges · 240 communities (197 shown, 43 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a1d448e5`
...
3. `MOVEment 2026 - Implementation Backlog` - 52 edges
4. `MOVEment 2026 - Current Specification` - 52 edges
5. `Team Gameplay V2 Analysis` - 50 edges
...
Cohesion: 0.08
Nodes (34): LeaderboardEntryResponse, TeamV2QrBadge(), TeamV2QrBadgeProps, TeamV2QrSubmitResult, clamp(), clampPercent(), clampScale(), getBaseMapScale() (+26 more)
...
### Community 18 - "api.ts"
Cohesion: 0.09
Nodes (37): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, cancelPlayerStation(), checkOutStation() (+29 more)
...
Cohesion: 0.09
Nodes (32): GAME_TYPE_OPTIONS, GAME_TYPES, ROLE_LABELS, STATUS_ORDER, createStoreState(), AuthAccount, GameType, LocalDatabase (+24 more)
...
Cohesion: 0.07
Nodes (6): ActivityLogService, Injectable, getEffectiveStationMaxPoints(), getStationPlaySeconds(), AdminService, Injectable
...
Cohesion: 0.11
Nodes (37): App(), authMatchesSession(), AuthMeResponse, FinalResponse, getLeaderboard(), getMe(), getPlayerFinal(), getPlayerLeaderboard() (+29 more)
...
Cohesion: 0.12
Nodes (15): SubmitFinalDto, IsOptional, IsString, UpdateFinalConfigDto, challenge, mockActivityLog, mockEventConfig, mockPrisma (+7 more)
...
Cohesion: 0.03
Nodes (62): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+54 more)
...
Cohesion: 0.04
Nodes (52): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+44 more)
...
Cohesion: 0.13
Nodes (33): qrcode, displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminStation(), createAdminTeam() (+25 more)
...
Cohesion: 0.10
Nodes (20): AdminAuthContext, AuthType, isAdmin(), TeamAuthContext, JwtAuthGuard, JwtPayload, Injectable, RolesGuard (+12 more)

### Community 189 - "CreateTeamDto"
Cohesion: 0.23
Nodes (9): getTeamV2OverlayStyle(), TeamV2OverlayStyle, TeamV2StationDetailOverlay(), TeamV2StationDetailOverlayProps, station, formatDateTime(), formatDurationFromMs(), getStationDisplayCode() (+1 more)
...
## Knowledge Gaps
- **1542 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1537 more)
...
- **Why does `assertSchemaReady()` connect `verify-seed.ts` to `StationsMapPanel.tsx`?**
