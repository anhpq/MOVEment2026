...
## Corpus Check
- 146 files · ~194,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1729 nodes · 2831 edges · 158 communities (140 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7adee8e6`
...
Cohesion: 0.05
Nodes (30): CurrentAuth, ForceProgressStatusDto, ReopenProgressDto, SubmitScoreDto, TeamSubmitScoreDto, IsEnum, IsInt, IsOptional (+22 more)

### Community 1 - "AdminService"
Cohesion: 0.33
Nodes (7): CreateTeamDto, IsOptional, IsString, MaxLength, MinLength, UpdateTeamDto, XlsxSheet
...
Cohesion: 0.20
Nodes (15): cameraErrorMessages, CameraFailureCategory, getCameraFailureCategory(), logCameraDiagnostic(), QrTokenInput(), QrTokenInputProps, ScannerState, waitForVideoMetadata() (+7 more)
...
Cohesion: 0.06
Nodes (31): 2026-07-20 Admin integration verification, 2026-07-20 Agent and Markdown docs refresh, 2026-07-20 Backend production CI/CD, 2026-07-20 BE host bootstrap (production ECS host), 2026-07-20 Docker frontend API proxy fix, 2026-07-20 heroes.nalth.top SPA routing fallback, 2026-07-20 Login 405 object-storage investigation, 2026-07-20 Remaining feature integration (+23 more)
...
Cohesion: 0.12
Nodes (16): 2026-07-22 Automatic URL Team QR completion, 2026-07-22 Final Challenge completion, 2026-07-22 Production-like integration verification completion, 2026-07-22 Secure Station QR completion, 2026-07-22 Station tracking and scoring completion, MOVEment 2026 - Implementation Backlog, Next Execution Order, P0 — Authentication and Session (+8 more)
...
Cohesion: 0.10
Nodes (11): QrActionDto, SubmitCipherDto, IsString, MinLength, Get, PlayerService, mockActivityLog, mockEventConfig (+3 more)
...
Cohesion: 0.32
Nodes (8): AuthContext, PlayerController, Body, Controller, Get, Param, Post, UseGuards
...
## Knowledge Gaps
- **856 isolated node(s):** `deploy.sh script`, `config`, `$schema`, `collection`, `sourceRoot` (+851 more)
...
- **Why does `createQrTokenFingerprint()` connect `Prompt 02 - Phân tích màn hình Player` to `AuthContext`, `AdminService`, `store.ts`, `AuthService`, `AppFrame.tsx`, `xlsx-report.ts`?**
