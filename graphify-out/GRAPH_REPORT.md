...
## Corpus Check
- 245 files · ~439,739 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2951 nodes · 4908 edges · 214 communities (186 shown, 28 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e75e6899`
...
2. `MOVEment 2026 - Implementation Backlog` - 57 edges
3. `MOVEment 2026 - Current Specification` - 56 edges
4. `Team Gameplay V2 Analysis` - 55 edges
...
Cohesion: 0.21
Nodes (6): JwtAuthGuard, JwtPayload, Injectable, QrActionDto, IsString, MinLength
...
Cohesion: 0.19
Nodes (11): PlayerController, Body, Controller, Get, Header, Param, Post, Res (+3 more)
...
Cohesion: 0.11
Nodes (35): checkInStation(), getPlayerStationPlayingCounts(), StationPlayingCountResponse, buildFallbackPositions(), buildMarkerPosition(), clampMapScale(), clampPercent(), getMarkerLegendBackground() (+27 more)
...
Cohesion: 0.07
Nodes (44): LeaderboardEntryResponse, submitPlayerQrAction(), DEFAULT_TEAM_V2_OVERLAY_OPACITY, getTeamV2OverlayStyle(), TeamV2OverlayStyle, TeamV2QrBadge(), TeamV2QrBadgeProps, clamp() (+36 more)
...
### Community 18 - "api.ts"
Cohesion: 0.07
Nodes (56): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, cancelPlayerStation(), checkOutStation() (+48 more)
...
Cohesion: 0.05
Nodes (57): TeamV2StationDetailOverlayProps, station, DEFAULT_STATION_MAX_POINTS, GAME_TYPE_OPTIONS, GAME_TYPES, ROLE, ROLE_LABELS, STATUS_ORDER (+49 more)
...
Cohesion: 0.13
Nodes (18): getLeaderboard(), getPlayerLeaderboard(), runPlayerRead(), useVisibleOnlinePolling(), VisibleOnlinePollingOptions, LeaderboardPage(), clearRuntimeRequestCoordinator(), clearSingleFlight() (+10 more)
...
Cohesion: 0.15
Nodes (13): AuthContext, CurrentAuth, AdminController, Body, Controller, Get, Header, Param (+5 more)
...
Cohesion: 0.18
Nodes (11): getEffectiveStationMaxPoints(), getStationPlaySeconds(), TIME_STATION_AUTO_SCORE, PLAYER_ERROR_CODES, PlayerActionException, PlayerErrorCode, mockActivityLog, mockEventConfig (+3 more)
...
Cohesion: 0.30
Nodes (9): displayStatus(), fetchAdminDatabase(), createAdminStation(), getAdminProgressMatrix(), getAdminStationQrTokens(), updateAdminStation(), useMovementBootstrap(), StationEditorPage() (+1 more)
...
Cohesion: 0.17
Nodes (21): apiDownloadBlob(), apiDownloadFile(), ApiErrorCode, buildApiUrl(), createRequestId(), createTimedSignal(), fetchApi(), getAccessToken() (+13 more)
...
Cohesion: 0.09
Nodes (32): App(), authMatchesSession(), AuthMeResponse, getMe(), logout(), ApiError, isAuthFailure(), RunningPersonIcon() (+24 more)
...
Cohesion: 0.13
Nodes (20): loginTeam(), loginTeamWithQr(), loginUser(), loginWithQrToken(), apiRequest(), LANGUAGE_FLAGS, LanguageSwitch(), LanguageSwitchProps (+12 more)
...
Cohesion: 0.03
Nodes (68): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+60 more)
...
Cohesion: 0.11
Nodes (34): @prisma/client, deleteStationRelatedActivityLogs(), replaceAllStations(), StationReplacementResult, verifyCanonicalStationState(), CANONICAL_QR_PURPOSES, CANONICAL_QR_TOKEN_COUNT, CANONICAL_ST_COUNT (+26 more)

### Community 179 - "MOVEment 2026 - Implementation Backlog"
Cohesion: 0.04
Nodes (57): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+49 more)
...
Cohesion: 0.09
Nodes (41): qrcode, buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminTeam(), deleteAdminStation(), deleteAdminTeam(), getAdminQrStatusSummary() (+33 more)
...
## Knowledge Gaps
- **1556 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1551 more)
...
- **Why does `createQrTokenFingerprint()` connect `createQrTokenFingerprint` to `PlayerService`, `reset-gameplay-seed.ts`, `player.service.ts`, `seed.ts`, `admin.service.ts`, `AdminService`, `sync-stations.ts`, `auth.service.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `SystemConfigPage.tsx`, `fe/package.json`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `useMovementStore` connect `useMovementStore` to `runtimeCoordinator.ts`, `store.ts`, `StationEditorPage.tsx`, `playerData.ts`, `StationsMapPanel.tsx`, `TeamGameplayV2Page.tsx`, `routes.tsx`, `api.ts`, `SystemConfigPage.tsx`, `LoginPage.tsx`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
