...
## Corpus Check
- 245 files · ~431,625 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2863 nodes · 4780 edges · 231 communities (190 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9270d6f6`
...
10. `MOVEment 2026 - Current Specification` - 34 edges
...
Cohesion: 0.10
Nodes (34): checkInStation(), buildFallbackPositions(), buildMarkerPosition(), clampMapScale(), clampPercent(), getMarkerLegendBackground(), getMarkerUiState(), isValidMapCoordinate() (+26 more)

### Community 4 - "dependencies"
Cohesion: 0.08
Nodes (25): @ant-design/icons, antd, dependencies, @ant-design/icons, antd, i18next, jsqr, konva (+17 more)
...
Cohesion: 0.09
Nodes (23): @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, sass (+15 more)
...
Cohesion: 0.12
Nodes (12): ActivityLogService, Injectable, challenge, mockActivityLog, mockEventConfig, mockPrisma, mockTx, PrismaModule (+4 more)
...
Cohesion: 0.15
Nodes (25): displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminStation(), deleteAdminStation(), deleteAdminTeam() (+17 more)
...
Cohesion: 0.08
Nodes (50): App(), authMatchesSession(), AuthMeResponse, FinalResponse, getLeaderboard(), getMe(), getPlayerFinal(), getPlayerLeaderboard() (+42 more)
...
Cohesion: 0.05
Nodes (40): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+32 more)
...
Cohesion: 0.07
Nodes (30): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+22 more)
...
Cohesion: 0.18
Nodes (15): getStationMarkerAppearance(), isStationMarkerCompleted(), isStationMarkerLocked(), StationMarkerAppearance, StationMarkerStateSource, createMarker(), getLayout(), viewport (+7 more)
...
Cohesion: 0.16
Nodes (14): loginWithQrToken(), apiRequest(), LANGUAGE_FLAGS, LanguageSwitch(), LanguageSwitchProps, normalizeLanguage(), readStoredLanguage(), SUPPORTED_LANGUAGES (+6 more)
...
## Knowledge Gaps
- **1451 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1446 more)
