...
## Corpus Check
- 245 files · ~436,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2925 nodes · 4846 edges · 238 communities (195 shown, 43 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c27a947b`
...
5. `MOVEment 2026 - Implementation Backlog` - 45 edges
6. `MOVEment 2026 - Current Specification` - 45 edges
7. `useMovementStore` - 44 edges
8. `PlayerService` - 43 edges
9. `Team Gameplay V2 Analysis` - 43 edges
...
Cohesion: 0.14
Nodes (24): checkInStation(), buildFallbackPositions(), buildMarkerPosition(), clampMapScale(), clampPercent(), getMarkerLegendBackground(), isValidMapCoordinate(), MARKER_THEME (+16 more)
...
Cohesion: 0.20
Nodes (17): cancelPlayerStation(), checkOutStation(), editAdminProgressScore(), forceAdminProgressStatus(), reopenAdminProgress(), submitStationScore(), apiPatch(), getTeamV2OverlayStyle() (+9 more)
...
Cohesion: 0.12
Nodes (25): submitPlayerQrAction(), TeamV2QrBadge(), TeamV2QrBadgeProps, clamp(), clampPercent(), clampScale(), getBaseMapScale(), getDefaultMapTransform() (+17 more)
...
### Community 18 - "api.ts"
Cohesion: 0.08
Nodes (45): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, deleteAdminStation(), deleteAdminTeam() (+37 more)
...
Cohesion: 0.06
Nodes (53): GAME_TYPE_OPTIONS, GAME_TYPES, ROLE_LABELS, STATUS_ORDER, ProtectedRouteProps, buildFinishedTeamStations(), buildPatchedTeamStations(), buildResetTeamStations() (+45 more)
...
Cohesion: 0.17
Nodes (14): RequestMetricsMiddleware, Injectable, AdminModule, Module, AuthModule, Module, EventConfigModule, Module (+6 more)
...
Cohesion: 0.19
Nodes (13): AuthContext, CurrentAuth, AdminController, Body, Controller, Param, Patch, Post (+5 more)
...
Cohesion: 0.06
Nodes (7): isSupportedYoutubeUrl(), getEffectiveStationMaxPoints(), getStationPlaySeconds(), Get, Header, AdminService, Injectable
...
Cohesion: 0.10
Nodes (29): FinalResponse, getLeaderboard(), getPlayerFinal(), getPlayerLeaderboard(), logout(), runPlayerRead(), submitFinalAnswer(), isAuthFailure() (+21 more)
...
Cohesion: 0.18
Nodes (4): Get, compareTeamResultRows(), TeamResultsService, Injectable
...
Cohesion: 0.18
Nodes (14): App(), authMatchesSession(), AuthMeResponse, getMe(), getSessionPrincipalKey(), getStoredSessionPrincipalKey(), hashSessionValue(), isSessionExpired() (+6 more)
...
Cohesion: 0.04
Nodes (55): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+47 more)
...
Cohesion: 0.04
Nodes (45): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+37 more)
...
Cohesion: 0.13
Nodes (34): qrcode, displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminStation(), createAdminTeam() (+26 more)
...
Cohesion: 0.08
Nodes (29): AdminAuthContext, AuthType, isAdmin(), isTeam(), TeamAuthContext, Roles(), JwtAuthGuard, JwtPayload (+21 more)
...
Cohesion: 0.27
Nodes (7): getPlayerStationPlayingCounts(), StationPlayingCountResponse, station, buildFallbackCounts(), normalizeCounts(), useStationPlayingCounts(), TeamStation
...
## Knowledge Gaps
- **1513 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1508 more)
...
- **Why does `createQrTokenFingerprint()` connect `createQrTokenFingerprint` to `verify-seed.ts`, `AuthContext`, `reset-gameplay-seed.ts`, `player.service.ts`, `seed.ts`, `auth.service.ts`?**
