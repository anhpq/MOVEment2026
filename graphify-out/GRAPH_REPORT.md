# Graph Report - MOVEment2026  (2026-08-08)

## Corpus Check
- 245 files · ~439,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2948 nodes · 4905 edges · 218 communities (192 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2334ddda`
...
2. `MOVEment 2026 - Implementation Backlog` - 56 edges
3. `MOVEment 2026 - Current Specification` - 56 edges
4. `AuthContext` - 54 edges
5. `Team Gameplay V2 Analysis` - 54 edges
6. `2026-07-28 Station Media Gallery and Player action layout` - 49 edges
7. `CurrentAuth` - 46 edges
8. `useMovementStore` - 44 edges
9. `PlayerService` - 43 edges
10. `2026-07-28 Station Media Gallery and Player action layout` - 42 edges
...
### Community 3 - "AppFrame.tsx"
Cohesion: 0.15
Nodes (15): RunningPersonIcon(), RunningPersonIconProps, appliedProperties, applyActiveTheme(), ThemeOwner, themeOwners, useBodyTeamTheme(), AppFrame() (+7 more)
...
Cohesion: 0.19
Nodes (15): AuthContext, CurrentAuth, Get, UseGuards, PlayerController, Body, Controller, Get (+7 more)
...
Cohesion: 0.08
Nodes (46): cancelPlayerStation(), checkInStation(), checkOutStation(), editAdminProgressScore(), forceAdminProgressStatus(), getPlayerStationPlayingCounts(), reopenAdminProgress(), StationPlayingCountResponse (+38 more)
...
Cohesion: 0.07
Nodes (40): LeaderboardEntryResponse, DEFAULT_TEAM_V2_OVERLAY_OPACITY, getTeamV2OverlayStyle(), TeamV2OverlayStyle, TeamV2QrBadge(), TeamV2QrBadgeProps, clamp(), clampPercent() (+32 more)
...
### Community 15 - "TeamV2QrScanner.tsx"
Cohesion: 0.14
Nodes (15): CameraErrorKey, getCameraErrorKey(), ScannerState, TeamV2QrScanner(), TeamV2QrScannerProps, TeamV2QrSubmitResult, FakeMediaStream, waitForVideoMetadata() (+7 more)
...
### Community 18 - "api.ts"
Cohesion: 0.09
Nodes (42): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, AuthMeResponse, downloadAdminSummary() (+34 more)
...
Cohesion: 0.06
Nodes (53): DEFAULT_STATION_MAX_POINTS, GAME_TYPE_OPTIONS, GAME_TYPES, ROLE, ROLE_LABELS, STATUS_ORDER, buildFinishedTeamStations(), buildPatchedTeamStations() (+45 more)
...
Cohesion: 0.14
Nodes (16): runPlayerRead(), useVisibleOnlinePolling(), VisibleOnlinePollingOptions, selectPlayerMapImageVariant(), clearRuntimeRequestCoordinator(), clearSingleFlight(), getNetworkConnection(), getTeamRuntimePollIntervalMs() (+8 more)
...
### Community 67 - "AdminController"
Cohesion: 0.12
Nodes (11): AdminController, Body, Controller, Get, Header, Param, Patch, Post (+3 more)

### Community 68 - "reset-gameplay-seed.ts"
Cohesion: 0.19
Nodes (18): assertResetGuards(), buildResetGameplayPlan(), executeResetGameplay(), ExecuteResetGameplayOptions, executeResetGameplayWithGuards(), getResetTarget(), main(), parseResetMode() (+10 more)

### Community 70 - "player.service.ts"
Cohesion: 0.15
Nodes (12): getEffectiveStationMaxPoints(), TIME_STATION_AUTO_SCORE, LeaderboardController, Controller, PLAYER_ERROR_CODES, PlayerActionException, PlayerErrorCode, mockActivityLog (+4 more)
...
Cohesion: 0.13
Nodes (18): CircularNeonGradientRing, CircularNeonGradientRingProps, clampColorChannel(), COLORS, getCircularGradientColor(), getCircularSilverColor(), hexToRgb(), INNER_PIN_PATH (+10 more)
...
Cohesion: 0.18
Nodes (10): Business Rule References, Current Implementation, Decision Log, Decisions and Stale Assumptions, Event Timing and Final Analysis, Interfaces and Data, Objective and Scope, Provenance (+2 more)
...
Cohesion: 0.12
Nodes (15): 2026-07-29 Runtime Stability Integration, 2026-08-02 Shared accessibility copy follow-up, 2026-08-02 Team V2 fullscreen copy, 2026-08-03 Team V2 Station preview copy, 2026-08-03 V2 default navigation localization, Boundaries, Business Rule References, Current Implementation (+7 more)
...
### Community 128 - "sync-stations.ts"
Cohesion: 0.18
...
Cohesion: 0.13
Nodes (27): App(), authMatchesSession(), getLeaderboard(), getMe(), getPlayerLeaderboard(), logout(), isAuthFailure(), useMovementBootstrap() (+19 more)
...
Cohesion: 0.33
Nodes (10): loginTeam(), loginTeamWithQr(), loginUser(), LoginFormValues, LoginPage(), mapBackendRole(), parseQrLoginPayload(), waitForVideoMetadata() (+2 more)
...
### Community 158 - "QrTokenInput.tsx"
Cohesion: 0.31
...
Cohesion: 0.11
Nodes (17): 2026-07-29 Runtime Stability Integration, 2026-08-03 Completed Station gameplay action, 2026-08-03 Shared Station identity row, 2026-08-03 Station Detail camera-first Check-out, 2026-08-03 Station List camera-first Check-in, 2026-08-03 Team score confirmation copy, 2026-08-03 Team score entry without reason, Business Rule References (+9 more)
...
Cohesion: 0.03
Nodes (67): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+59 more)
...
### Community 178 - "station-seed-data.ts"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (56): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+48 more)
...
Cohesion: 0.11
Nodes (38): qrcode, displayStatus(), fetchAdminDatabase(), buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminStation(), createAdminTeam() (+30 more)

### Community 185 - "teamTheme.ts"
Cohesion: 0.52
Nodes (6): DEFAULT_TEAM_COLOR, getTeamThemeVars(), hexToRgb(), hexToRgba(), mixWith(), normalizeTeamColor()
...
Cohesion: 0.24
Nodes (13): createUniqueQrLoginToken(), createUniqueStationQrToken(), ensureStationQrToken(), createUniqueStationQrToken(), buildQrLoginUrl(), createQrTokenFingerprint(), createSecureQrLoginToken(), createSecureStationQrToken() (+5 more)
...
Cohesion: 0.29
Nodes (6): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action

### Community 211 - "teamV2MarkerLayout.ts"
Cohesion: 0.12
Nodes (25): COMPLETED_MARKER_OPACITY, getStationMarkerAppearance(), isStationMarkerCompleted(), isStationMarkerLocked(), SELECTED_COMPLETED_MARKER_OPACITY, StationMarkerAppearance, StationMarkerStateSource, createMarker() (+17 more)

### Community 213 - "LanguageSwitch.tsx"
Cohesion: 0.23
Nodes (8): LANGUAGE_FLAGS, LanguageSwitch(), LanguageSwitchProps, LANGUAGE_STORAGE_KEY, normalizeLanguage(), readStoredLanguage(), SUPPORTED_LANGUAGES, translationResources
...
## Knowledge Gaps
- **1553 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1548 more)
...
- **Why does `createQrTokenFingerprint()` connect `createQrTokenFingerprint` to `PlayerService`, `reset-gameplay-seed.ts`, `player.service.ts`, `seed.ts`, `AdminService`, `station-seed-data.ts`, `admin.service.ts`, `auth.service.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `SystemConfigPage.tsx`, `fe/package.json`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `useMovementStore` connect `useMovementStore` to `AppFrame.tsx`, `store.ts`, `StationsMapPanel.tsx`, `LoginPage.tsx`, `TeamGameplayV2Page.tsx`, `routes.tsx`, `SystemConfigPage.tsx`, `playerData.ts`, `QrLoginPage.tsx`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
