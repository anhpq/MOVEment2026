...
## Corpus Check
- 245 files · ~429,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2839 nodes · 4754 edges · 233 communities (193 shown, 40 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48693c6f`
...
Cohesion: 0.07
Nodes (27): devDependencies, eslint, globals, jest, @nestjs/cli, @nestjs/schematics, prisma, ts-jest (+19 more)
...
### Community 18 - "api.ts"
Cohesion: 0.08
Nodes (46): AdminCreatedStationResponse, AdminOneTimeTeamQrResponse, AdminProgressMatrixResponse, AdminQrLoginTokenResponse, AdminStationUpdateInput, AdminTeamResponse, createAdminStation(), downloadAdminSummary() (+38 more)
...
Cohesion: 0.09
Nodes (36): displayStatus(), fetchAdminDatabase(), getAdminProgressMatrix(), GAME_TYPE_OPTIONS, GAME_TYPES, ROLE_LABELS, STATUS_ORDER, createStoreState() (+28 more)
...
Cohesion: 0.13
Nodes (31): qrcode, buildAdminQrStatusRecords(), AdminQrStatusSummaryResponse, AdminStationQrTokenResponse, createAdminTeam(), deleteAdminStation(), deleteAdminTeam(), getAdminQrStatusSummary() (+23 more)
...
Cohesion: 0.08
Nodes (24): AdminAuthContext, AuthType, isAdmin(), isTeam(), TeamAuthContext, Roles(), JwtAuthGuard, JwtPayload (+16 more)
...
Cohesion: 0.13
Nodes (25): @prisma/client, createUniqueStationQrToken(), deleteStationRelatedActivityLogs(), replaceAllStations(), StationReplacementResult, verifyCanonicalStationState(), CANONICAL_QR_PURPOSES, CANONICAL_STATION_IDS (+17 more)
...
Cohesion: 0.17
Nodes (19): App(), authMatchesSession(), AuthMeResponse, getMe(), useMovementBootstrap(), usePlayerStatePolling(), ProtectedRoute(), ProtectedRouteProps (+11 more)
...
Cohesion: 0.06
Nodes (34): 2026-07-28 Admin System Config localization fix, 2026-07-28 Admin System Config Station locale display, 2026-07-28 Production deploy preflight and partial smoke, 2026-07-28 Team Gameplay V2 parallel implementation, 2026-07-28 Tester auto-stop conflicting local processes, 2026-07-28 YouTube-style Player video action, 2026-07-29 Team Gameplay V2 fixed-palette isolation, 2026-07-29 Team Gameplay V2 HUD and Team Color reconciliation (+26 more)
...
Cohesion: 0.08
Nodes (24): 2026-07-29 Team runtime stability resume completion, 2026-07-30 Canonical Station seed data synchronization, 2026-07-30 Team Gameplay V2 marker anchoring and footer refinement, 2026-07-30 Team Gameplay V2-owned Detail and map HUD, 2026-07-30 Team V2 scanner-pin marker refinement, 2026-07-30 Team V2 score and banner rails refinement, 2026-07-31 Team V2 background-only overlay opacity, 2026-07-31 Team V2 centered score-only map header (+16 more)
...
Cohesion: 0.09
Nodes (27): FinalResponse, getLeaderboard(), getPlayerFinal(), getPlayerLeaderboard(), LeaderboardEntryResponse, runPlayerRead(), submitFinalAnswer(), isAuthFailure() (+19 more)
...
Cohesion: 0.24
Nodes (8): getTeamV2OverlayStyle(), TeamV2OverlayStyle, TeamV2StationDetailOverlay(), TeamV2StationDetailOverlayProps, station, TeamStation, formatDateTime(), formatDurationFromMs()
...
Cohesion: 0.26
Nodes (12): cancelPlayerStation(), checkOutStation(), getPlayerStationPlayingCounts(), reopenAdminProgress(), submitStationScore(), buildFallbackCounts(), normalizeCounts(), useStationPlayingCounts() (+4 more)

## Knowledge Gaps
- **1427 isolated node(s):** `deploy.sh script`, `fs`, `input`, `changedFiles`, `detectedMigrationChanges` (+1422 more)
