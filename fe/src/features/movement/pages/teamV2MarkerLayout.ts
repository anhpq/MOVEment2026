export const STATION_LABEL_WIDTH = 82;
export const STATION_LABEL_HEIGHT = 26;
...
export const MIN_MARKER_SIZE = 50;
export const BASE_MARKER_SIZE = 58;
export const MAX_MARKER_SIZE = 76;
