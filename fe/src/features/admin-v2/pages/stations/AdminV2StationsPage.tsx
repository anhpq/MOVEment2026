...
export function AdminV2StationsPage() {
  ...
  const columns = useMemo<TableColumnsType<AdminV2StationListItem>>(() => [
    ...
    {title: t("adminV2.stations.columns.maxPoints"), key: "maxPoints", align: "right", width: 120, render: (_, station) => station.maxPoints === null ? "???" : station.maxPoints ?? t("adminV2.stations.notAvailable")},
