...
export const CANONICAL_STATION_INPUT: CanonicalStationInput[] = [
  ...
  { name: 'Song Tâm Dẫn Ngọc', nameEn: 'Twin Hearts, Guided Gem', shortDescription: 'Một viên ngọc chông chênh đang chờ những nhịp lòng dẫn lối.', shortDescriptionEn: 'A precarious gem awaits the guidance of beating hearts.', youtubeLink: null, maxScore: 50, mapX: 77.18491103, mapY: 77.5261417, gameType: 'standard' },
