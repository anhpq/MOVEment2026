...
export const CANONICAL_STATION_INPUT: CanonicalStationInput[] = [
  { name: 'Thủy Lộ Ký Ức', nameEn: 'Memory Waterway', shortDescription: 'Dòng nước êm đềm dẫn lối ta đi, liệu điều gì đã bị lãng quên?', shortDescriptionEn: 'A gentle stream guides our way, what has been forgotten?', youtubeLink: 'https://www.youtube.com/shorts/ZEsYjNMSVXI', maxScore: 10, mapX: 46.22961734, mapY: 87.55421871, gameType: 'ST' },
  { name: 'Ngự Ảnh Tái Hiện', nameEn: 'Imperial Reflection', shortDescription: 'Giữa chốn hoàng cung, bóng hình năm cũ đang chờ ngày trở lại.', shortDescriptionEn: 'Amidst the royal palace, figures from the past await their return.', youtubeLink: 'https://youtu.be/USiXAUqd_Xo?si=1Xs8DQaiAjQtVumM', maxScore: 10, mapX: 14.67705457, mapY: 67.46147259, gameType: 'ST' },
  { name: 'Vạn Vật Ghi Tâm', nameEn: 'Mindful Relics', shortDescription: 'Muôn vật thoáng qua trong chớp mắt, tâm trí ta lưu giữ điều gì ?', shortDescriptionEn: 'All things pass in the blink of an eye, what does our mind retain?', youtubeLink: 'https://www.youtube.com/watch?v=05qtFxN-2bI', maxScore: 12, mapX: 70.4706302, mapY: 52.05187384, gameType: 'ST' },
  { name: 'Thiên Địa Chao Đảo', nameEn: 'Tilting Heaven and Earth', shortDescription: 'Khi nhạc nổi lên và đất trời nghiêng ngả, liệu ai còn giữ vững được mình?', shortDescriptionEn: 'When the music plays and the world tilts, who can still hold their ground?', youtubeLink: 'https://www.youtube.com/shorts/JAeGyyyTbhc', maxScore: 10, mapX: 66.11272887, mapY: 34.49381157, gameType: 'ST' },
  { name: 'Phi Thuyền Xuyên Không', nameEn: 'Time-Skipping Vessel', shortDescription: 'Ngoài quỹ đạo quen thuộc, một chuyến du hành kỳ lạ đang chờ đợi.', shortDescriptionEn: 'Beyond the familiar orbit, a strange journey awaits.', youtubeLink: null, maxScore: 10, mapX: 53.24718271, mapY: 71.83090008, gameType: 'standard' },
  ...
  { name: 'Vòng Quay Công Lý', nameEn: 'Wheel of Justice', shortDescription: 'Khi bánh xe cất lời, phán quyết sẽ thuộc về ai?', shortDescriptionEn: 'When the wheel speaks, to whom will the verdict belong?', youtubeLink: null, maxScore: 50, mapX: 65.60074589, mapY: 83.44960501, gameType: 'standard' },
  { name: 'Song Tâm Dẫn Ngọc', nameEn: 'Twin Hearts, Guided Gem', shortDescription: 'Một viên ngọc chông chênh đang chờ những nhịp lòng dẫn lối.', shortDescriptionEn: 'A precarious gem awaits the guidance of beating hearts.', youtubeLink: null, maxScore: 50, mapX: 85.84656084656085, mapY: 71.6931216931217, gameType: 'standard' },
  ...
  { name: 'Bách Thú Quy Hội', nameEn: 'Gathering of Beasts', shortDescription: 'Giữa muôn thanh âm, liệu chúng ta có tìm thấy nhau?', shortDescriptionEn: 'Amidst countless sounds, will we find each other?', youtubeLink: null, maxScore: 10, mapX: 18.55097488, mapY: 50.31129788, gameType: 'standard' },
  { name: 'Mê Trận Đồng Tâm', nameEn: 'Maze of One Heart', shortDescription: 'Giữa mê trận rối ren, liệu đồng lòng có mở được lối ra?', shortDescriptionEn: 'In the midst of a tangled maze, will unity open the way out?', youtubeLink: null, maxScore: 10, mapX: 60.84044646, mapY: 45.53447676, gameType: 'standard' },
  { name: 'Trụ Vững Càn Khôn', nameEn: 'Pillar of Balance', shortDescription: 'Khi càn khôn chuyển động, điều gì vẫn còn đứng vững?', shortDescriptionEn: 'When the universe shifts, what still stands firm?', youtubeLink: null, maxScore: 15, mapX: 74.92580611, mapY: 59.29883029, gameType: 'standard' },
  { name: 'Liên Hoàn Thần Chưởng', nameEn: 'Chain of Divine Palms', shortDescription: 'Một nhịp lỡ làng, cả chuỗi liền đứt đoạn.', shortDescriptionEn: 'One missed beat, and the entire chain is broken.', youtubeLink: null, maxScore: 15, mapX: 90.06484405, mapY: 57.51286895, gameType: 'standard' },
  { name: 'Hỏa Nhãn Kim Tinh', nameEn: 'Golden-Eyed Focus', shortDescription: 'Điều khác biệt thường ẩn nơi mắt người dễ bỏ qua.', shortDescriptionEn: 'The difference is often hidden where the eye easily overlooks.', youtubeLink: null, maxScore: 10, mapX: 60.93772104, mapY: 34.54244886, gameType: 'standard' },
  { name: 'Tam Sao Thất Vậy', nameEn: 'Three Stars Astray', shortDescription: 'Liệu sự thật có còn nguyên vẹn như ban đầu?', shortDescriptionEn: 'Will the truth remain as intact as it was in the beginning?', youtubeLink: null, maxScore: 10, mapX: 46.95785525, mapY: 64.91263989, gameType: 'standard' },
  { name: 'Vạn Ly Trường Thành', nameEn: 'Great Wall of Many Miles', shortDescription: 'Từ những điều nhỏ bé, liệu một kỳ tích có thể thành hình?', shortDescriptionEn: 'From small things, can a miracle take shape?', youtubeLink: null, maxScore: 10, mapX: 21.69461993, mapY: 69.41447427, gameType: 'standard' },
  { name: 'Nhất Nhịp Đồng Tâm', nameEn: 'One Beat, One Heart', shortDescription: 'Khi mọi bước chân cùng hòa một nhịp, lối đi phía trước sẽ dần hiện ra.', shortDescriptionEn: 'When all footsteps harmonize to one beat, the path ahead will gradually appear.', youtubeLink: null, maxScore: 10, mapX: 27.53376395, mapY: 63.82028301, gameType: 'standard' },
];
